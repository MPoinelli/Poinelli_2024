...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
     ...
     &     shelficeForcingTR,
     &     shiTransCoeffT, shiTransCoeffS, shiTransCoeffT_mult,
     &     shiCDragFld, shiDragQuadFld,
     &     shelfice_thdrive, shelfice_sadrive, 
     &     shelfice_uloc, shelfice_vloc
      ...
      _RL shiTransCoeffT_mult   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
